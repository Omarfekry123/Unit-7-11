...
local sheetWalkingNinja = graphics.newImageSheet( "assets/images/ninjaBoyThrow.png", sheetOptionsWalk )
...
local sheetWalkingNinja = graphics.newImageSheet( "assets/images/ninjaBoyDead.png", sheetOptionsWalk )
